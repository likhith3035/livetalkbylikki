      ...
      <footer className="border-t border-border/30 px-6 py-10 pb-24 lg:pb-10 bg-card/10">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-8 text-sm text-muted-foreground">
            <span className="cursor-pointer hover:text-foreground transition-colors duration-200" onClick={() => navigate("/info")}>About</span>
            <span className="cursor-pointer hover:text-foreground transition-colors duration-200" onClick={() => navigate("/info")}>Safety</span>
            <span className="cursor-pointer hover:text-foreground transition-colors duration-200">Terms</span>
          </div>
