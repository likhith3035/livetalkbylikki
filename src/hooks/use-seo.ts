...
const DEFAULT_KEYWORDS = "livetalk, live talk, livetalk chat, livetalk app, omegle alternative, omegle 2, anonymous chat, chat with strangers, random chat, video chat strangers, talk to strangers, likhith kami, likki";
